...
\section{Oscillatore sinusoidale di Wien}
	...
	Per la valutazione della distorsione della sinusoide ottenuta si utilizza il calcolo del THD riportato nell'\textit{Equazione \ref{eq:thd}}:
...
\section{XR2206}
	...
	Le prestazioni ottenute con questo tipo di antenna sono le mostrate in \textit{Figura \ref{fig:SINxr+LP}} e in \textit{Figura \ref{fig:SINx}} rispettivamente. Dove si possono vedere le sinusoidi in uscita dall'XR2206 quando l'antenna è montata, ma non vi è la presenza della mano nelle vicinanze. Ovvero l'oscillazione base d'uscita.
