...
\label{sc: oscillatore wien sperimentale}
	...
	In figura (PORCO DUE) è riportato lo schematico dell'oscillatore di Wien utilizzato per generare la sinusoide di riferimento alla frequenza di 158755522 \textit{kHz}. 

	IMMAGINE

	L'oscillatore è stato montato prima su una breadboard, dove si pò notare la sinusoide in uscita in figura PINCOPALLO e la sua FFT in figura PICOPALLO2.
	...
	Successivamente si è spostato il crcuito su basetta millefori. Ottenendo il seganle riportato in figura ZIOBESTIA, la cui \textit{FFT} è riportata in figura ZIOBESTIA2 e il \textit{THD} riportato in tabella ZIOBESTIONE.
	...
	Si può notare che i due segneli, quello in figura PINCOPALLO e quello in figura ZIOBESTIA presentano una frequenza di oscillazione differente. Questo è dovuto alle capacità parassite introdote dalla breadboard che aggiungono un offset capacitivo pari a circa \textit{88 pF}.
